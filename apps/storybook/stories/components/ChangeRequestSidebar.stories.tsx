...
import { ChangeRequestSidebar, type ChangeRequestSidebarProps } from "@fabbit/components";
...
} satisfies ChangeRequestSidebarProps["changeRequest"];

const meta = {
  title: "Components/ChangeRequestSidebar",
  component: ChangeRequestSidebar,
  tags: ["autodocs"],
  parameters: {
    layout: "padded",
  },
  args: {
    changeRequest: sampleChangeRequest,
...
} satisfies Meta<typeof ChangeRequestSidebar>;
