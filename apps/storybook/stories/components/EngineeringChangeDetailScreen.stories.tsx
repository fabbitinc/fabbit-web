...
import { EngineeringChangeDetailScreen } from "@fabbit/components";

function EngineeringChangeDetailScreenStory() {
...
const meta = {
  title: "Components/EngineeringChangeDetailScreen",
  component: EngineeringChangeDetailScreenStory,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
  },
} satisfies Meta<typeof EngineeringChangeDetailScreenStory>;
...
export const Default: Story = {
  render: () => <EngineeringChangeDetailScreenStory />,
};
