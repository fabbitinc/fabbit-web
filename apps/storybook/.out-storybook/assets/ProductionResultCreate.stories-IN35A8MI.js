...
import { r as k } from "./iframe-DjFiVPSj.js";
import {
  d as o,
  e as d,
  L as S,
...
import { F as D } from "./factory-DN9g8WId.js";
...
const m = e.jsxs("div", {
  ...
  p = [
    ...
    { id: "org", label: "조직 설정", icon: j, onClick: () => {} },
  ],
  g = [
    {
      id: "main",
      items: [
        { id: "dashboard", label: "대시보드", icon: S, onClick: () => {} },
        { id: "projects", label: "프로젝트", icon: h, onClick: () => {} },
  ...
  s = {
    render: () =>
      e.jsx(o, {
        ...
        sidebar: e.jsx(d, { isDesktop: !0, sections: g }),
        isDesktop: !0,
        mainClassName: "p-6",
        children: e.jsx(A, {}),
      }),
...
const U = ["Default", "Filled", "OverPlan", "Submitting"];
export {
  s as Default,
  t as Filled,
  n as OverPlan,
