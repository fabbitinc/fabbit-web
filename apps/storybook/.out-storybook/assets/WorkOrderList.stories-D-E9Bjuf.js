...
import { F as k } from "./factory-DN9g8WId.js";
...
const l = e.jsxs("div", {
  ...
  m = { name: "김태현", email: "taehyun@fabbit.io" },
  u = [
  ...
  d = [
    {
      ...
      items: [
        ...
        { id: "parts", label: "부품 관리", icon: h, onClick: () => {} },
        {
          id: "production",
          label: "생산",
          icon: k,
  ...
  a = {
    render: () =>
      e.jsx(n, {
        ...
        sidebar: e.jsx(s, { isDesktop: !0, sections: d }),
        isDesktop: !0,
        mainClassName: "p-6",
        children: e.jsx(o, {
          items: c,
