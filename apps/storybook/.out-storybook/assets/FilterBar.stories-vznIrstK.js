import{j as e}from"./index-BC33NHKD.js";import{r as n}from"./iframe-BDY6rKdT.js";import{r as o}from"./change-request-detail-screen-BB3V5S0M.js";import{B as m}from"./user-avatar-Cz1MQ_Sd.js";import{S as d}from"./sliders-horizontal-B7OInr_X.js";import"./index-C3SxMwu4.js";import"./preload-helper-PPVm8Dsz.js";import"./circle-alert-Df3U-mR7.js";import"./chevrons-up-down-BJxNzKgS.js";import"./sparkles-CdpkT6Re.js";import"./settings-CQ3R25cq.js";import"./tag-gRIXPjqS.js";const w={title:"Components/FilterBar",component:o,tags:["autodocs"],parameters:{layout:"centered"}},r={render:()=>{const[a,t]=n.useState("");return e.jsx("div",{className:"w-[600px]",children:e.jsx(o,{searchValue:a,searchPlaceholder:"작업지시 번호, 품목명으로 검색...",onSearchChange:t})})}},s={render:()=>{const[a,t]=n.useState(""),[i,c]=n.useState([{id:"process",label:"공정: CNC 밀링"},{id:"status",label:"상태: 진행중"},{id:"line",label:"라인: A동 2라인"}]);return e.jsx("div",{className:"w-[600px]",children:e.jsx(o,{searchValue:a,searchPlaceholder:"작업지시 번호, 품목명으로 검색...",chips:i,onSearchChange:t,onChipRemove:l=>c(h=>h.filter(p=>p.id!==l)),onClearAll:()=>c([]),actions:e.jsxs(m,{variant:"outline",size:"sm",children:[e.jsx(d,{className:"mr-2 size-4"}),"필터"]})})})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => {
