...
import { F as y } from "./factory-DN9g8WId.js";
...
const d = e.jsxs("div", {
  ...
  l = { name: "김태현", email: "taehyun@fabbit.io" },
  c = [
    { id: "profile", label: "개인 설정", icon: b, onClick: () => {} },
    { id: "org", label: "조직 설정", icon: k, onClick: () => {} },
  ],
  m = [
    {
      id: "main",
      items: [
        { id: "dashboard", label: "대시보드", icon: p, onClick: () => {} },
        { id: "projects", label: "프로젝트", icon: g, onClick: () => {} },
        { id: "changes", label: "변경 관리", icon: h, onClick: () => {} },
  ...
  a = {
    render: () =>
      e.jsx(t, {
        ...
        sidebar: e.jsx(s, { isDesktop: !0, sections: m }),
        isDesktop: !0,
        mainClassName: "p-6",
        children: e.jsx(n, {
          items: u,
