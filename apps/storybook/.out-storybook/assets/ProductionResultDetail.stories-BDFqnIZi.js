...
import { E as c, F as d, G as l, J as m } from "./user-avatar-CJtlkw0_.js";
import { F as S } from "./factory-DN9g8WId.js";
...
const p = e.jsxs("div", {
  ...
  u = { name: "김태현", email: "taehyun@fabbit.io" },
  b = [
    { id: "profile", label: "개인 설정", icon: D, onClick: () => {} },
    { id: "org", label: "조직 설정", icon: T, onClick: () => {} },
  ],
  h = [
    {
      id: "main",
      items: [
        ...
        { id: "projects", label: "프로젝트", icon: k, onClick: () => {} },
        { id: "changes", label: "변경 관리", icon: f, onClick: () => {} },
        { id: "parts", label: "부품 관리", icon: j, onClick: () => {} },
        {
          id: "production",
          label: "생산",
          icon: S,
  ...
  t = {
    render: () =>
      e.jsx(o, {
        ...
        sidebar: e.jsx(n, { isDesktop: !0, sections: h }),
        isDesktop: !0,
        mainClassName: "p-6",
        children: e.jsx(r, {
          result: x,
...
t.parameters = {
  ...
  render: () => <AppShell header={<AppHeader brand={brand} user={mockUser} onToggleSidebar={() => {}} search={{
    ...
    dialogPlaceholder: "작업번호, 품목명 검색..."
      ...
      <ProductionResultDetailScreen result={mockResult} activeTab="history" tabContent={<HistoryTabContent />} onBack={() => {}} onTabChange={() => {}} onEdit={() => {}} onCreateDefectRecord={() => {}} />
    </AppShell>
}`,
...
s.parameters = {
  ...
  render: () => <AppShell header={<AppHeader brand={brand} user={mockUser} onToggleSidebar={() => {}} search={{
    ...
    dialogPlaceholder: "작업번호, 품목명 검색..."
      ...
      <ProductionResultDetailScreen result={mockResult} activeTab="defects" tabContent={<DefectsTabContent />} onBack={() => {}} onTabChange={() => {}} onEdit={() => {}} onCreateDefectRecord={() => {}} />
    </AppShell>
}`,
...
a.parameters = {
  ...
  render: () => <AppShell header={<AppHeader brand={brand} user={mockUser} onToggleSidebar={() => {}} search={{
    ...
    dialogPlaceholder: "작업번호, 품목명 검색..."
      ...
      <ProductionResultDetailScreen result={mockCompletedResult} activeTab="defects" tabContent={<EmptyDefectsTabContent />} onBack={() => {}} onTabChange={() => {}} onEdit={() => {}} onCreateDefectRecord={() => {}} />
    </AppShell>
}`,
...
const z = ["WithDefects", "DefectsTab", "Completed"];
export {
  a as Completed,
  s as DefectsTab,
  t as WithDefects,
