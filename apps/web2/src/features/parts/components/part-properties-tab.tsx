...
import { PartDrawingPreview } from "@/features/parts/components/part-drawing-preview";
import type { PartDetailModel } from "@/features/parts/types/parts-model";

interface PartPropertiesTabProps {
...
export function PartPropertiesTab({
  ...
  const rows: { label: string; value: ReactNode }[] = [
    ...
    { label: "상태", value: part.lifecycleState ? <Badge variant={getLifecycleVariant(part.lifecycleState)}>{part.lifecycleState}</Badge> : "미지정" },
