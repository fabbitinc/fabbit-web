import { FileText, Network, ArrowUpDown, ArrowUp, ArrowDown, ChevronLeft, ChevronRight } from "lucide-react";
import { Badge, Button, Checkbox, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@fabbit/ui";
import type { PartListItemModel, PartListSortKey, PartListSortOrder } from "@/features/parts/types/parts-model";
        ...
        <table className="min-w-full border-collapse">
          <thead>
            <tr className="border-b border-border/70 bg-muted/30">
              ...
              <SortableHeader column="lifecycleState" label="상태" sortKey={sortKey} sortOrder={sortOrder} onSortChange={onSortChange} />
